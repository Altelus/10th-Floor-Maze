/* Window Implementation - Window Component - Windowing Branch
 *
 * Window.cpp
 * fwk4gps version 1.0
 * gam666/dps901
...
#include "Window.h"         // for the Window class declaration
...
//------------------------------ Window ---------------------------------------
//
// The Window Component creates, manages, and destroys the main application
// window
//
...
// setup (re)creates the main application window
//
void* Window::setup() {
...
// handleMessage checks for a message in the message queue and
// processes that message if one exists
// if the message is to quit, sets rc and keepgoing and returns them
//
bool Window::handleMessage(int& rc, bool& keepgoing) const {
